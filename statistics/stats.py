    ...
    for name in names:
        ...
        for wav in wavs:
            ...
            if 'entertain' in wav or 'entertian' in wav:
                entertain['uttnum'] += 1
                entertain['dur'] += dur
            elif 'interview' in wav or 'added' in wav or 'interiew' in wav:
                interview['uttnum'] += 1
                interview['dur'] += dur
            elif 'song' in wav or 'music' in wav:
                song['uttnum'] += 1
                song['dur'] += dur
                p_song += 1
            elif 'act' in wav or 'play' in wav or 'comic' in wav or 'paly' in wav:
                act['uttnum'] += 1
                act['dur'] += dur
            elif 'movie' in wav or 'movies' in wav or 'moive' in wav: 
                movie['uttnum'] += 1
                movie['dur'] += dur
            elif 'vlog' in wav or 'Vlog' in wav:
                vlog['uttnum'] += 1
                vlog['dur'] += dur
            elif 'live' in wav:
                live['uttnum'] += 1
                ...
                speech['uttnum'] += 1
                speech['dur'] += dur
            elif 'tvs' in wav or 'tv' in wav:
                tvs['uttnum'] += 1
                tvs['dur'] += dur
            elif 'recite' in wav:
                recite['uttnum'] += 1
                recite['dur'] += dur
            elif 'advertise' in wav or 'ad' in wav:
                advertise['uttnum'] += 1
                advertise['dur'] += dur
            else:
                print(name + ' ' + wav)
